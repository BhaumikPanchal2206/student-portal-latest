            ...
            <div className='px-4 grid grid-cols-2 gap-4'>
                <div className="bg-white dark:bg-gray-800 shadow-lg border border-white dark:border-black rounded-lg overflow-hidden">
                    ...
                    <div className="py-4">
                        ...
                        <div className='mt-3'>
                            <Link href="/exam/result" className="bg-blue-500 mx-4 dark:bg-gray-100 text-white dark:text-gray-800 py-2 px-4 rounded">Show Results</Link>
                        </div>
                    </div>
                </div>
                <div>
                ...
                <div className="bg-white dark:bg-gray-800 shadow-lg border border-white dark:border-black rounded-lg overflow-hidden">
                    ...
                    <div className="p-4">
                        ...
                        <p className="text-gray-700 dark:text-gray-100 mb-4">With supporting text below as a natural lead-in to additional content.</p>
                        <Link href="/exam/result" className="bg-blue-500 dark:bg-gray-100 text-white dark:text-gray-800 py-2 px-4 rounded">Show Results</Link>
                    </div>
                </div>
                <div className="bg-white dark:bg-gray-800 shadow-lg border border-white dark:border-black rounded-lg overflow-hidden">
                    <div className="bg-blue-800 text-xl dark:bg-gray-900 text-white py-2 px-4">
